...
def publish(t,u,a):
 ...
 log(f"📦 Container Meta creato: {cid}");wait_container(t,cid);d=api(requests.post(f"{GRAPH_BASE}/v24.0/{u}/media_publish",data={"creation_id":cid,"access_token":t},timeout=30));mid=str(d.get("id") or "")
